...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0x35, 0xc5, 0x05, 0xf9, 0x79, 0xc5, 0xa9, 0x42, 0x12, 0x5c, 0xec, 0xb9, 0xa9, 0xc5, 0xc5, 0x89,
	0xe9, 0x30, 0x75, 0x30, 0xae, 0x91, 0x07, 0x97, 0x20, 0x58, 0x69, 0x78, 0x7e, 0x51, 0x4e, 0x4a,
	0x70, 0x6a, 0x51, 0x59, 0x66, 0x72, 0xaa, 0x90, 0x31, 0x17, 0x47, 0x70, 0x62, 0x25, 0x58, 0x5c,
	0x48, 0x50, 0x2f, 0xb1, 0x20, 0x53, 0x0f, 0xd9, 0x4a, 0x29, 0x21, 0x64, 0x21, 0x88, 0x0d, 0x4a,
	0x0c, 0x49, 0x6c, 0x60, 0x47, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x60, 0x11, 0xdc, 0x45,
	0xb3, 0x00, 0x00, 0x00,
}
...
func (c *helloWorldServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.HelloWorldService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHelloWorldServiceServer) SayHello(ctx context.Context, req *HelloRequest) (*HelloResponse, error) {
...
func _HelloWorldService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.HelloWorldService/SayHello",
	}
...
var _HelloWorldService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.HelloWorldService",
